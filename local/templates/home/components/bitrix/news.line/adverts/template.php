							...
							<div class="prop-more-info">
								<div class="inner d-flex">
									<div class="col">
										...
										<strong><? echo $arItem["PROPERTY_AREA_VALUE"] ?>м<sup>2</sup></strong>
									</div>
									<div class="col">
										<span><?= GetMessage('STAGES') ?>:</span>
										<strong><? echo $arItem["PROPERTY_STAGES_VALUE"] ?></strong>
									</div>
									<div class="col">
										<span><?= GetMessage('BATHS') ?>:</span>
										<strong><? echo $arItem["PROPERTY_BATHS_VALUE"] ?></strong>
									</div>
									<div class="col">
										<span><?= GetMessage('GARAGE') ?>:</span>
										<strong><? echo $arItem["PROPERTY_GARAGE_VALUE"] ?></strong>
									</div>
								</div>
							</div>
						</div>
