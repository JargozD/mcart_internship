				...
				<div class="bg-white">
					<div class="row mb-5">
						...
						<div class="col-md-6">
							<ul class="property-specs-wrap mb-3 mb-lg-0  float-lg-right">
								...
								<li>
									<span class="property-specs"><?= GetMessage("STAGES_COUNT") ?></span>
									<span class="property-specs-number"><?= $arResult["DISPLAY_PROPERTIES"]["STAGES"]["DISPLAY_VALUE"] ?></span>

								</li>
								<li>
									<span class="property-specs"><?= GetMessage("TOTAL_AREA") ?></span>
									<span class="property-specs-number"><?= $arResult["DISPLAY_PROPERTIES"]["AREA"]["DISPLAY_VALUE"] ?> <sup>2</sup></span>
					...
					<div class="row mb-5">
						<div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
							<span class="d-inline-block text-black mb-0 caption-text"><?= $arResult["DISPLAY_PROPERTIES"]["BATHS"]["NAME"] ?></span>
							<strong class="d-block"><?= $arResult["DISPLAY_PROPERTIES"]["BATHS"]["DISPLAY_VALUE"] ?></strong>
						</div>
						<div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
					...
					<div class="mt-5">
						...
						<? foreach ($arResult["DISPLAY_PROPERTIES"]["ADDITIONAL_MATERIALS"]["DISPLAY_VALUE"] as $arItem) : ?>
							<div>
								<a href="<?= $arItem ?>">Посмотреть похожий дом</a>
							</div>
						<? endforeach; ?>
					</div>

					<div class="mt-5">
						<h2 class="h4 text-black mb-3"><?= GetMessage("LINKS_OUT") ?></h2>
						<? foreach ($arResult["DISPLAY_PROPERTIES"]["LINKS_OUT"]["VALUE"] as $arItem) : ?>
							<div>
								<a href="<?= $arItem ?>">Перейти на внешний ресурс</a>
							</div>
						<? endforeach; ?>
					</div>
